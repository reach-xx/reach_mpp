    ...
    VO_DEV VoDev, SAMPLE_VO_MODE_E enVoMode)
{
    ...
    *************************************************/
    SAMPLE_COMM_VDEC_ModCommPoolConf(&stModVbConf, PT_H264, &stSize, s32VdecCnt); 
    ...
    ******************************************/
     ...
     ******************************************/
    SAMPLE_COMM_VDEC_ThreadParam(s32VdecCnt, &stVdecSend[0], &stVdecChnAttr[0], SAMPLE_1080P_H264_PATH); 
    SAMPLE_COMM_VDEC_StartSendStream(s32VdecCnt, &stVdecSend[0], &gs_SendParam[0]);
...
END_8: 
    ...
    /******************************************
     step 12: join thread
    ******************************************/
    SAMPLE_COMM_VDEC_StopSendStream(s32VdecCnt, &stVdecSend[0], &gs_SendParam[0]);
